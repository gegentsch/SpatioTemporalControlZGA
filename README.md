...
*Gentsch, G.E., Owens, N.D.L, and Smith, J.C. (2018). The Spatio-Temporal Control of Zygotic Genome Activation. BioRxiv, xxxxxx.*
  ...
  * [2. Profiling Zygotic Genome Activation](#profiling-zygotic-genome-activation)
    ...
    + [2.3 High time-resolution of exonic and intronic RNA](#high-time-resolution-of-exonic-and-intronic-rna)
    + [2.4 4sU tagging of nascent transcripts](#su-tagging-of-nascent-transcripts)
    + [2.5 Statistics](#statistics)
    + [2.6 Correlations](#correlations)
    + [2.7 Chromatin and RNA dynamics](#chromatin-and-rna-dynamics)
    + [2.8 Hilbert curves](#hilbert-curves)
    + [2.9 Gene annotations](#gene-annotations)
    + [2.10 Regional gene expression](#regional-gene-expression)
    + [2.11 Spatio-temporal dynamics](#spatio-temporal-dynamics)
    + [2.12 Gene architecture](#gene-architecture)
    + [2.13 Maternal and zygotic contributions to transcriptome](#maternal-and-zygotic-contributions-to-transcriptome)
    + [2.14 Functional annotations](#functional-annotations)
  * [3. Signal-Mediated Zygotic Genome Activation](#signal-mediated-zygotic-genome-activation)
    + [3.1 Differential expression analysis](#differential-expression-analysis)
    + [3.2 Hierarchical clustering of transcriptional misregulations](#hierarchical-clustering-of-transcriptional-misregulations)
    + [3.3 Functional analysis of misregulated genes](#functional-analysis-of-misregulated-genes)
    + [3.4 Transcriptional effects resolved in space and time](#transcriptional-effects-resolved-in-space-and-time)
    + [3.5 Synergistic effects](#synergistic-effects)
    + [3.6 Summary](#summary)
